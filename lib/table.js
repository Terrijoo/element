            ...
            [
              _c("table-footer", {
                ...
                attrs: {
                  ...
                  "default-sort": _vm.defaultSort,
                  "use-summary-html": _vm.useSummaryHtml
                }
              })
            ],
            1
    ...
    updateTreeData: function updateTreeData() {
      ...
      var _loop = function _loop(prop) {
        if (newTreeData.hasOwnProperty(prop)) {
          var found = Object.values(newTreeData).find(function (data) {
            return data.children.find(function (child) {
              return child === prop;
            });
          });
          if (found) {
    ...
    loadData: function loadData(row, key, treeNode) {
      ...
      if (load && !treeData[key].loaded) {
        ...
        load(row, treeNode, function (data) {
          ...
          var othersLoading = Object.values(treeData).find(function (treeData) {
      ...
      [h('colgroup', [this.columns.map(function (column) {
        ...
        [h('tr', [this.columns.map(function (column, cellIndex) {
          return h(
            ...
            [!_this.useSummaryHtml ? h(
              'div',
              { 'class': ['cell', column.labelClassName] },
              [sums[cellIndex]]
            ) : h('div', { 'class': ['cell', column.labelClassName], directives: [{
                name: 'html',
                value: sums[cellIndex]
              }]
            })]
          );
