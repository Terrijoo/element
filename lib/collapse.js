...
/* harmony default export */ var collapsevue_type_script_lang_js_ = ({
  ...
  methods: {
    setActiveNames: function setActiveNames(activeNames, activeItem) {
    ...
    handleItemClick: function handleItemClick(item) {
      if (this.accordion) {
        this.setActiveNames((this.activeNames[0] || this.activeNames[0] === 0) && this.activeNames[0] === item.name ? '' : item.name, item);
      } else {
